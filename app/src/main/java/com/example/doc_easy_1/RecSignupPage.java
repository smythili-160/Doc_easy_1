...
public class RecSignupPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rec_loginRedirectText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(RecSignupPage.this, RecLoginPage.class);
        ...
        rec_signup_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(fAuth.getCurrentUser() != null){
                    Intent intent=new Intent(new Intent(getApplicationContext(), RecHomePage.class));
                    startActivity(intent);
                    finish();
                ...
                if(rec_name.isEmpty() || rec_email.isEmpty() || rec_password.isEmpty() || rec_username.isEmpty() || rec_phoneno.isEmpty() ){
                    Toast.makeText( RecSignupPage.this, "Please fill all fields", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                fAuth.createUserWithEmailAndPassword(rec_email, rec_password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(RecSignupPage.this, "user creation successful", Toast.LENGTH_SHORT).show();
                                    userID=fAuth.getCurrentUser().getUid();
                                    SharedPreferences sharedPreferences = RecSignupPage.this.getSharedPreferences("app", MODE_PRIVATE );
                                    ...
                                    Intent intent=new Intent(RecSignupPage.this, RecHomePage.class);
                                    startActivity(intent);
                                    finish();
                                } else {
                                    progressBar.setVisibility(View.INVISIBLE);
                                    Toast.makeText(RecSignupPage.this, "user creation unsuccessful", Toast.LENGTH_SHORT).show();
