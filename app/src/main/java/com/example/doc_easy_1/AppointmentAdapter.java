...
public class AppointmentAdapter extends ArrayAdapter<Appointment> {
    ...
    private void updateViews(ViewHolder holder, Appointment appointment) {
        ...
        holder.ageTextView.setText(String.valueOf(appointment.getAge()));
                ...
                appointmentRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if (documentSnapshot.exists()) {
                            ...
                            startPatientDetailsActivity(appointmentID, appointmentDetails);
                        } else {
    ...
    private void startPatientDetailsActivity(String appointmentID, Bundle appointmentDetails) {
